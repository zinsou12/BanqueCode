...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <section class="content">
          ...
          <section class="content-header">
          <h6 id="success">CREDITER LE COMPTE</h6>
        </section>
        ...
        <section class="content">
          <div class="row">
            <div class="col-md-12">
                ...
                <form method="POST" action="{{route('update', ['id'=>$id])}}" id="updateform">
                    @csrf
                    <input type='hidden' value="{{config('app.url')}}" id='url'>
                    <input type='hidden' value="{{$id}}" id='id'>
                  <div class="box box-danger">
                <div class="box-header">
                  <h3 class="box-title">Nouveau montant pour l'utilisateur {{$nom}} {{$prenom}}</h3>
                </div>
                <div class="box-body">
    ...
    <script src="{{asset('public/admins/update.js')}}"></script>
</body>
