                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                ...
                                <p class="fs-5">Transfert terminé</p>
                            </div>
                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>etape1 terminé</td>
                                    <td>etape2 terminé</td>
                                    <td>etape3 terminé</td>
                                    <td>etape4 terminé</td>
                                    <td>etape5 terminé</td>
                                    <td>etape6 terminé</td>
