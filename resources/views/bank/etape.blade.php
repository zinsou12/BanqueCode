        ...
        <div class="row clearfix" >
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <input type="hidden" value={{$pourcentage}} id="pourcentage">
                        <div class="body" id="divBody">
                            <div id="bodyHid">
                                ...
                                <form method="post" id="formulaire" action="{{route('etape')}}">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}" id="token">
                                        <label for="text">Code de verification</label>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" class="form-control" placeholder="Code de verification" id="codeVerification" name="codeVerification">
